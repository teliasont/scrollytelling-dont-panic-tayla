...
document.addEventListener("DOMContentLoaded", () => {
 gsap.set("#planet", {
    autoAlpha: 1,            // sets opacity=1 + visibility=visible
    scale: 0,                // still tiny
...
if (prefersReducedMotion) {
  ...
  gsap.set("#planet", { scale: 1, xPercent: 70, yPercent: -50, rotation: 0, autoAlpha:1 });
  gsap.set("#ufo", {
    opacity: 1,
    x: 0,
    y: 0,
  ...
  const boxTL = gsap.timeline({
    scrollTrigger: {
      ...
      aniticipatePin: 1,
      snap: {
        //Gemini helped with the snapping to prevent the last box from being so sticky.
        snapTo: (value, self) => {
    ...
    if (i === 23) {
      ...
      if (currentColor === brightGreen) {
        boxTL.to(
          "body",
          {
            "--colorswap-bright": "var(--brightorange)",
            duration: 2,
            ease: "power2.inOut",
          },
          `box_${i}_in+=0.75`,
        ...
        boxTL.to(
          "body",
          {
            "--colorswap-light": "var(--lightorange)",
            duration: 2,
            ease: "power2.inOut",
          },
          `box_${i}_in+=0.75`,
        ...
        boxTL.to(
          "body",
          {
            "--colorswap-bright-alt": "var(--brightgreen)",
            duration: 2,
            ease: "power2.inOut",
          },
          `box_${i}_in+=0.75`,
        ...
        boxTL.to(
          "body",
          {
            "--colorswap-bright": "var(--brightgreen)",
            duration: 2,
            ease: "power2.inOut",
          },
          `box_${i}_in+=0.75`,
        ...
        boxTL.to(
          "body",
          {
            "--colorswap-light": "var(--lightgreen)",
            duration: 2,
            ease: "power2.inOut",
          },
          `box_${i}_in+=0.75`,
        ...
        boxTL.to(
          "body",
          {
            "--colorswap-bright-alt": "var(--brightorange)",
            duration: 2,
            ease: "power2.inOut",
          },
          `box_${i}_in+=0.75`,
  ...
  const dropdownTween = gsap.fromTo(
    ".dropdown-container",
    { y: 10 },
    {
      y: -100,
...
gsap.set("#planet", {
  ...
  const planetTween = gsap.timeline();
